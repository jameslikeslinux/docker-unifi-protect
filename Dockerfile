...
RUN wget --progress=dot:mega https://apt.ubnt.com/pool/main/u/unifi-protect/unifi-protect.jessie~stretch~xenial~bionic_arm64.v1.12.5.deb -O unifi-protect.deb \
